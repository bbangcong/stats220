...
# 2020
fresh_potato <- image_read("https://cdn.pixabay.com/photo/2016/08/11/08/49/
                           potatoes-1585075_1280.jpg") %>%
  image_scale(500)

# 2021
sitting_potato <- image_read("https://cdn.pixabay.com/photo/2012/12/24/08/39/
                         agriculture-72254_1280.jpg") %>%
  image_scale(500)

# 2022
rotten_potato <- image_read("https://cdn.pixabay.com/photo/2016/03/05/19/11/
                            age-1238308_1280.jpg") %>%
  image_scale(500)
